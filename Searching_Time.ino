...
// Function that return the introduced time by the user
my_hour=readingtime();
...
////////////////////////////////////////////////////////////////////////////
  ...
  if (n == arrayPointer && counter == 0) {
      Serial.println("No readings values found for that TIME. Please, introduce again the time.");    
   }else {}
...
/////////////////////////////////////////////////////////////////////////////////////////////////
// In case the variable HOUR_ is less than ten, the index "to" of the substring function updates
...
/////////////////////////////////////////////////////////////////////////////////////////////////
// In case the value of the variable MINUE_ introduced by the user is less than ten, that is, 
// only one digit, the value of the variable MINUE_ is updated to two digits (adding a zero (0))
/////////////////////////////////////////////////////////////////////////////////////////////////
